...
This is an unofficial, community-maintained project and is not associated with Apple. We also maintain [unofficial documentation](https://github.com/czechboy0/XcodeServer-API-Docs) of Xcode Server in case you'd like to integrate through a different programming language! :wink:
