...
If your problem requires a deep discussion or you have a great idea and you really want to share it with someone before opening an issue you can join the official [Buildasaurs](https://github.com/buildasaurs) **Slack team**! (To do so, go to this [website](https://buildasaurs.herokuapp.com) and have your e-mail address ready :e-mail:)
